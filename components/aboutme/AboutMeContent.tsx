    ...
    <div className="max-w-4xl text-justify mt-8">
      ...
      <section className="mb-6">
        ...
        >
          ...
          <StrongtagWidget>Nagercoil</StrongtagWidget>, a small yet beautiful
          town in Kanyakumari, Tamil Nadu. I completed my schooling in my
          hometown before pursuing my bachelor's degree spending two years in
          Dehradun, India, and the final two years in Sheffield, United Kingdom.
          After graduating, I returned to India to begin my professional
          journey. A couple of years later, in 2021, I moved to Germany for my
          master’s, and I’ve been living here ever since.
        </motion.p>
      </section>
      ...
      <section className="mb-6">
        ...
        >
          ...
          <StrongtagWidget>clean design</StrongtagWidget>,{" "}
          <StrongtagWidget>solid architecture</StrongtagWidget>, and
          <StrongtagWidget> meaningful user experiences</StrongtagWidget>. I
          enjoy building scalable systems and working with modern technologies
          across the stack. My favourite frameworks are Flutter, React, Tauri,
          ReactNative.
        </motion.p>
      </section>
      ...
      <section className="mb-6">
        ...
        >
          ...
          <StrongtagWidget>clean code</StrongtagWidget>,{" "}
          <StrongtagWidget>giving honest feedback</StrongtagWidget>. If
          something feels bloated or overcomplicated, I’ll likely rebuild it
      ...
      <section className="mb-6">
        ...
        >
          ...
          <li>
            I enjoy playing video games — mostly competitive, strategy or sci-fi
            themes.
          </li>
        </motion.ul>
      </section>
