  ...
  return (
    <div className="max-w-4xl text-justify">
      ...
      <section className="mb-6">
        ...
        >
          <li>
            Completed the foundational two years of my engineering education in
            India.
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        >
          ...
          <li>
            Learned the fundamentals of programming, algorithms, search, machine
            learning, and logic in Python.
          </li>
          <li>
            This course sparked my love for programming and set the stage for my
