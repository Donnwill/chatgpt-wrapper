    ...
    <div className="max-w-4xl text-justify">
      <section className="mb-6">
        ...
        <motion.h2 {...fadeUp} className="text-xl font-figtreeBold text-app-primarytext mb-2">
          Intermediate Software Developer — Sensit! GmbH, Germany (Sep 2023 –
          Present)
        </motion.h2>
        <motion.ul
          {...fadeInRight}
        ...
        >
          <li>
            ...
            <StrongtagWidget>Rust</StrongtagWidget> for backend performance and{" "}
            <StrongtagWidget>React with TypeScript</StrongtagWidget> for a
            type-safe frontend. Standardized styling across products and
          ...
          <li>
            ...
            synchronous hardware using the Tokio runtime. Collaborated closely
            with the design team, independently managing tasks to enhance{" "}
            <StrongtagWidget>visual appeal</StrongtagWidget> and{" "}
            <StrongtagWidget>user experience</StrongtagWidget>.
          </li>
          <li>
            Designed, developed, and maintained Rust-based microservices with a
            distributed <StrongtagWidget>SQLite (TURSO)</StrongtagWidget>{" "}
            database for internal and external services.
          </li>
          <li>
            Contributed to the development and optimization of complex CI/CD
            pipelines in <StrongtagWidget>Azure</StrongtagWidget>, ensuring code
            quality through{" "}
            <StrongtagWidget>
              rigorous testing, linting, building and releasing
            </StrongtagWidget>{" "}
            across a multi-product <StrongtagWidget>mono repo</StrongtagWidget>.
          </li>
          <li>
            Led internal projects, driving team efficiency and ensuring project
            success.
          </li>
          <p className="font-figtreeSemiBold text-app-primarytext">Achievements:</p>
          <li>
            Recognized for outstanding performance with an{" "}
            <StrongtagWidget>
              award of company shares and bonuses
            </StrongtagWidget>
            , reflecting my contributions to key projects and overall company
            success.
          </li>
        </motion.ul>
      </section>
      ...
      <section className="mb-6">
        <motion.h2 {...fadeUp} className="text-xl font-figtreeBold text-app-primarytext mb-2">
          Junior Software Developer — Sensit! GmbH, Germany (Aug 2021 – Aug
          2023)
        </motion.h2>
        <motion.ul
          {...fadeInRight}
        ...
        >
          ...
          <li>
            {" "}
            Experienced with <StrongtagWidget>MongoDB</StrongtagWidget> and{" "}
          ...
          <li>
            Integrated Bluetooth connectivity to read and write firmware values.
          </li>
          <li>
            Added new features, including firmware update progress tracking and
          ...
          <li>
            ...
            <StrongtagWidget>
              UWP (C#), JavaFX (Java), ElectronJS (JavaScript), Tauri (React,
              TypeScript), and Compose Multiplatform
            </StrongtagWidget>
            .
          </li>
          <p className="font-figtreeSemiBold text-app-primarytext">Achievements:</p>
      ...
      <section className="mb-6">
        ...
        >
          <li>
            ...
            <StrongtagWidget>HTML</StrongtagWidget>, focusing on both frontend
            and backend development.
          </li>
          <li>
            Developed a mobile application for an automated testing tool{" "}
            <StrongtagWidget>(ACRA)</StrongtagWidget>, implementing UI and core
            functionalities using <StrongtagWidget>Dart </StrongtagWidget>and{" "}
            <StrongtagWidget>Flutter </StrongtagWidget>.
          </li>
          <p className="font-figtreeSemiBold text-app-primarytext">Achievements:</p>
          <li>
            Developed complete front-end mobile application functionalities in 3
            months.
          </li>
      ...
      <section className="mb-6">
        <motion.h2 {...fadeUp} className="text-xl font-figtreeBold text-app-primarytext mb-2">
          Design Engineer — Ozone Engineering Solutions, India (Feb 2018 – Jul
          2019)
        </motion.h2>
        <motion.ul
          {...fadeInRight}
        ...
        >
          <li>
            Designed innovative 2D and 3D machine guards tailored to customer
            requirements.
          </li>
          <li>
            <StrongtagWidget>Collaborated with customers</StrongtagWidget> to
            identify issues and provide creative solutions.
          </li>
          <p className="font-figtreeSemiBold text-app-primarytext">Achievements:</p>
          <li>
